...
namespace PeliculasAPI.Tests
{
    ...
    public class LocalDbDatabaseInitializer
    {
        ...
        //Este metodo con el attributo de assembly creamos una base de datos cuando
        //ejecutamos el test suit
        [AssemblyInitialize]
        ...
        //Aqui cuando el test suit termina la ejecucion la base de datos creada se elimina
        [AssemblyCleanup]
